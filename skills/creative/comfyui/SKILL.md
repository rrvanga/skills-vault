...
compatibility: "Requires ComfyUI (local, Comfy Desktop, or Comfy Cloud) and comfy-cli (pin: comfy-cli==1.16.0; auto-installed via pipx/uvx by the setup script)."
prerequisites:
  commands: ["python3"]
setup:
...
pipx install comfy-cli==1.16.0
# Or use uvx without installing:
uvx --from comfy-cli==1.16.0 comfy --help
# Or (if pipx/uvx unavailable):
pip install --user comfy-cli==1.16.0
```
...
- [ ] `comfy --version` works (or `uvx --from comfy-cli==1.16.0 comfy --help`)
