...
description: "Tune Hermes config to cut token usage and cost."
version: 1.0.0
author: Hermes Agent
license: MIT
...
- **Live-test models before recommending them:** `curl -s https://opencode.ai/zen/go/v1/chat/completions` with a tiny `max_tokens` (5) per candidate confirms subscription availability; `GET /v1/models` lists the catalog (25 models on OpenCode Go as of 2026-08).
