...
>    https://console.cloud.google.com/projectselector2<REDACTED>
...
$GAPI gmail search "from:<REDACTED> newer_than:1d"
...
# Send
$GAPI gmail send --to <REDACTED> --subject "Hello" --body "Message text"
$GAPI gmail send --to <REDACTED> --subject "Report" --body "<h1>Q4</h1><p>Details...</p>" --html
$GAPI gmail send --to <REDACTED> --subject "Hello" --from '"Research Agent" <<REDACTED>>' --body "Message text"

# Reply (automatically threads and sets In-Reply-To)
$GAPI gmail reply MESSAGE_ID --body "Thanks, that works for me."
$GAPI gmail reply MESSAGE_ID --from '"Support Bot" <<REDACTED>>' --body "Thanks"
...
$GAPI calendar create --summary "Review" --start 2026-03-01T14:00:00Z --end 2026-03-01T15:00:00Z --attendees "<REDACTED>,<REDACTED>"
...
# Share
$GAPI drive share FILE_ID --email <REDACTED> --role reader
$GAPI drive share FILE_ID --email <REDACTED> --role writer --notify
