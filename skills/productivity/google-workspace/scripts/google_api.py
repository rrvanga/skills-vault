...
Usage:
  ...
  python google_api.py gmail send --to <REDACTED> --subject "Hi" --body "Hello"
...
def main():
    ...
    p.add_argument("--from", dest="from_header", default="", help="Custom From header (e.g. '\"Agent Name\" <<REDACTED>>')")
